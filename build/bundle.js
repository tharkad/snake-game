var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			attr(div, "class", div_class_value = "" + (null_to_empty(/*foodType*/ ctx[3]) + " svelte-npovch"));
    		...
    		p(ctx, dirty) {
    			if (dirty & /*foodType*/ 8 && div_class_value !== (div_class_value = "" + (null_to_empty(/*foodType*/ ctx[3]) + " svelte-npovch"))) {
    				attr(div, "class", div_class_value);
    			}
    ...
    // (204:10) {#each sizes as size}
    function create_each_block$1(ctx) {
    	let option;
    	let t0_value = /*size*/ ctx[19] + "";
    	let t0;
    	let t1;
    	...
    	return {
    		c() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			option.__value = option_value_value = /*size*/ ctx[19];
    ...
    function create_fragment$3(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*gameOver*/ ctx[7]) return create_if_block$2;
    		return create_else_block$1;
    	}

    	let current_block_type = select_block_type(ctx);
    	let if_block = current_block_type(ctx);
    	let each_value = /*sizes*/ ctx[10];
    	let each_blocks = [];
    	...
    	return {
    		c() {
    			...
    			if (/*sizeSelected*/ ctx[6] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[18].call(select));
    		...
    		m(target, anchor, remount) {
    			...
    			dispose = [
    				listen(window, "keydown", /*onKeyDown*/ ctx[12]),
    				listen(select, "change", /*select_change_handler*/ ctx[18]),
    				listen(select, "change", /*scaleChanged*/ ctx[11])
    			];
    		},
    		p(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*score*/ 256) set_data(t2, /*score*/ ctx[8]);
    			if (!current || dirty & /*speed*/ 512) set_data(t4, /*speed*/ ctx[9]);

    			if (dirty & /*sizes*/ 1024) {
    				each_value = /*sizes*/ ctx[10];
    				let i;
    			...
    			if (dirty & /*foodType*/ 8) food_changes.foodType = /*foodType*/ ctx[3];
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function snakeAteFood() {
    		...
    		$$invalidate(13, interval = Math.floor(scale / newSpeed));
    		$$invalidate(9, speed = Math.floor(Math.floor(scale / interval * 10000) / 100));
    	}
    	...
    	function resetGame() {
    		...
    		$$invalidate(13, interval = Math.floor(scale * 8));
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*snakeBodies*/ 32) {
    			 $$invalidate(8, score = snakeBodies.length - 3);
    		}

    		if ($$self.$$.dirty & /*scale, interval*/ 8193) {
    			 $$invalidate(9, speed = Math.floor(scale / interval * 100));
    		}
    	};
